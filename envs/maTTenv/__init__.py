...
def make(env_name, render=False, figID=0, record=False, directory='',
    ...
    elif env_name == 'setTracking-vGoal':
        from envs.maTTenv.env.setTracking_vGoal import setTrackingEnvGoal
        env0 = setTrackingEnvGoal(num_agents=num_agents, num_targets=num_targets, **kwargs)
